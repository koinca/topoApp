...
app.controller('MainCtrl', ['$scope', 'VisDataSet', 'ajaxService', '$q',
    ...
    function($scope, VisDataSet, ajaxService, $q) {
        ...
        $scope.getNetworkData = function() {
            $scope.updateStatus = 'Simulatio in progress, please wait...';
        ...
        function setUpdateStatus() {
            $scope.updateStatus = 'Simulation complete';
        }
                ...
                (function(ind) {
                    setTimeout(function() {
                        ...
                        if (topoData.edges[ind].link == 'UP') {
                            ...
                            _.merge(topoData.nodes['to'], {
                                color: 'red'
                            });
                            _.merge(topoData.nodes['from'], {
                                color: 'lightorange'
                            });
        ...
        function drawTopo(topoData) {
            ...
            network.on("click2", function(params) {
